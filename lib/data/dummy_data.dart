...
final List<Wisata> daftarWisata = [
  ...
  Wisata(
    ...
    deskripsiSingkat: 'Surga bawah laut dengan keanekaragaman hayati laut terkaya di dunia.',
    deskripsiLengkap: 'Raja Ampat merupakan kepulauan di Papua Barat Daya yang sangat terkenal dengan keindahan bawah lautnya. Terdiri dari empat pulau besar: Waigeo, Batanta, Salawati, dan Misool. Tempat ideal untuk menyelam dan snorkeling.',
    urlGambar: 'https://images.unsplash.com/photo-1549477026-b8c1165a6e87?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzNzcyNzV8MHwxfHNlYXJjaHwxfHxyYWphJTIwYW1wYXR8ZW58MHx8fHwxNzA2MjY5MTk0fDA&ixlib=rb-4.0.3&q=80&w=1080',
  ),
  Wisata(
    id: 'w4',
    nama: 'Raja Ampat',
  ...
  // Kamu bisa menambahkan lebih banyak data di sini!
];
